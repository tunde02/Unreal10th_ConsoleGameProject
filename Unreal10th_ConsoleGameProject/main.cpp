...
//  [ ] 코드 정리 및 주석
//  [ ] 문서
//      - 제목, 작성자 이름, 게임 소개, 게임 조작법, 클래스 목록과 클래스의 기능 설명
//  [ ] 아이템
//  [ ] 클리어 연출
// 
...
//  [x] 플레이어에 발사 딜레이 추가
//  [x] BaseScene.RenderSceneObjects()에서 플레이어를 제일 나중에 그리도록 변경
//  [x] 플레이어가 탄막에 맞으면 일정시간 깜빡이면서 무적시간이 있어야됨
//  [x] 중력, ground 삭제
//  [x] 플레이어 이동 벽에 막히도록 수정
